package tokyo.isseikuzumaki.nlt.service
...
import tokyo.isseikuzumaki.nlt.data.model.NotificationRecord
import tokyo.isseikuzumaki.nlt.domain.parser.PaymentParser
...
class NLTNotificationListenerService : NotificationListenerService() {
    ...
    private suspend fun saveToFirestore(record: NotificationRecord) {
        try {
            ...
            tokyo.isseikuzumaki.nlt.data.repository.FirestoreRepositoryImpl.saveNotificationRecord(record)
        } catch (e: Exception) {
